package me.saurabhrane.mvp.data.local
...
interface RecentSearchDao {
    ...
    suspend fun insert(query: me.saurabhrane.mvp.data.local.Query)

    @Query("SELECT * FROM query_table ORDER BY id DESC")
    fun getAllSearchQueries(): Flow<List<me.saurabhrane.mvp.data.local.Query>>
